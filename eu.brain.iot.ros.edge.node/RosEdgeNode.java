...
public class RosEdgeNode extends AbstractNodeMain implements SmartBehaviour<BrainIoTEvent>{
    ...
    /*		this.voltageFrequency = config.voltageFrequency(); //2 ||*/
		...
		/*	logger.info("Hello!  I am ROS Edge Node ");	
	    	System.out.println("Hello!  I am ROS Edge Node ");
	    	try {
				this.wait();
			} catch(InterruptedException e){
				logger.error("ROS Edge Node activate Exception: {}", ExceptionUtils.getStackTrace(e));
				System.out.println("ROS Edge Node activate Exception: {}"+ ExceptionUtils.getStackTrace(e));
			}*/
	...
	/*    try {
			...
			logger.error("\n ROS Edge Node Exception in Activate(): {}", ExceptionUtils.getStackTrace(e));
		}*/
	//    ros.addNode(this);
