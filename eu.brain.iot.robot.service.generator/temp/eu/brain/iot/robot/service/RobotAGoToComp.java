 ...
 * RobotAGoToComp object = new RobotAGoToComp (){};
 * Otherwise, the abstract method need to be overrided when instantiation
 */
public abstract class RobotAGoToComp {
    ...
    public RobotAGoToComp(String robotName, ConnectedNode node, MessageFactory Factory) {
    ...
    public void register() {
        ...
        gotoCancle.register("/rb1_base_a/robot_local_control/NavigationComponent/GoToComponent/cancel", "procedures_msgs/ProcedureQuery");
        gotoQuery = new GenericComponentImpl<ProcedureQueryRequest, ProcedureQueryResponse>(node);
        gotoQuery.register("/rb1_base_a/robot_local_control/NavigationComponent/GoToComponent/query_state", "procedures_msgs/ProcedureQuery");
    }
