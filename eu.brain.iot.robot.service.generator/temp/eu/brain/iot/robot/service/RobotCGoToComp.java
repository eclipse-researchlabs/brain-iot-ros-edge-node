 ...
 * RobotCGoToComp object = new RobotCGoToComp (){};
 * Otherwise, the abstract method need to be overrided when instantiation
 */
public abstract class RobotCGoToComp {
    ...
    public RobotCGoToComp(String robotName, ConnectedNode node, MessageFactory Factory) {
    ...
    public void register() {
        ...
        gotoRun.register("/rb1_base_c/robot_local_control/NavigationComponent/GoToComponent/add", "robot_local_control_msgs/GoToPetition");
        gotoCancle = new GenericComponentImpl<ProcedureQueryRequest, ProcedureQueryResponse>(node);
        gotoCancle.register("/rb1_base_c/robot_local_control/NavigationComponent/GoToComponent/cancel", "procedures_msgs/ProcedureQuery");
        gotoQuery = new GenericComponentImpl<ProcedureQueryRequest, ProcedureQueryResponse>(node);
        gotoQuery.register("/rb1_base_c/robot_local_control/NavigationComponent/GoToComponent/query_state", "procedures_msgs/ProcedureQuery");
    }
