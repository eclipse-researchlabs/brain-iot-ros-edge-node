...
@Component(
		service = {InitDataReader.class},
		immediate=true
	)
public class InitDataReader {
	
	private HashMap<Integer,Coordinate> unload=new HashMap<Integer,Coordinate>();

	private HashMap<Integer,String> Cart=new HashMap<Integer,String>();
	
	private Coordinate placeCenter = null;
	private Coordinate placeLeft = null;
	private Coordinate placeRight = null;
	

	public InitDataReader() throws IOException
	{
		loadPose();
		loadCart();
	...
	public Coordinate json2Cooridinate(JSONObject data) {
		Coordinate cooridinate = new Coordinate();
	...
	public Coordinate GetCooridinate(int pickPoseID, String mission) {
